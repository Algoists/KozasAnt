...
namespace KozasAnt.Client
{
    public static class WellKnown
    {
        public static class Colors
        {
            ...
            public static readonly Color Food = Color.Black;
            public static readonly Color Gap = Color.Gray;
            public static readonly Color AntIs = Color.Red;
            public static readonly Color AntWas = Color.HotPink;
        }
